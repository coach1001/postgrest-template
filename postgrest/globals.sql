...
-- Started on 2017-06-17 23:52:02 SAST
...
ALTER ROLE authenticator WITH NOSUPERUSER NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'md558f29e8f4b7c276a4cd58bda1771aa49';
CREATE ROLE file_uploader;
ALTER ROLE file_uploader WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
...
CREATE ROLE "user";
ALTER ROLE "user" WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB NOLOGIN NOREPLICATION NOBYPASSRLS;
...
GRANT file_uploader TO authenticator GRANTED BY postgres;
GRANT file_uploader TO "user" GRANTED BY postgres;
GRANT "user" TO authenticator GRANTED BY postgres;
...
CREATE DATABASE "postgrest-template" WITH TEMPLATE = template0 OWNER = postgres;
...
--
-- TOC entry 2130 (class 1262 OID 12411)
-- Dependencies: 2129
...
-- Completed on 2017-06-17 23:52:02 SAST

--
-- PostgreSQL database dump complete
--

\connect -reuse-previous=on "dbname='postgrest-template'"
...
-- Completed on 2017-06-17 23:52:03 SAST
...
-- Started on 2017-06-17 23:52:03 SAST
